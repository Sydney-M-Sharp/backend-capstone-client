...
export default function Navbar() {
  ...
  return (
    ...
    <nav 
      className="navbar mb-3 is-white px-5 is-fixed-top is-top" 
      role="navigation" aria-label="main navigation"
      style={{backgroundImage: `url(https://t3.ftcdn.net/jpg/00/22/35/86/360_F_22358642_TlOPo0uu0tAb22YINFwY1UDKxFON8TFR.jpg)`}}
    >
